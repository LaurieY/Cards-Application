...
doc.addImage(imgData, 'JPEG', 30,30, 16, 10,'u3aLogo');
...
doc.setDrawColor(0);
var leftLine = [14, firstcard.y-(cardgaps.y/2),20, firstcard.y-(cardgaps.y/2)];
var rightLine =[195, firstcard.y-(cardgaps.y/2),190, firstcard.y-(cardgaps.y/2)];

var topLine =[ firstcard.x-(cardgaps.x/2) ,10  , firstcard.x-(cardgaps.x/2) ,15 ];
var bottomLine =[ firstcard.x-(cardgaps.x/2) ,287  , firstcard.x-(cardgaps.x/2) ,280 ];
